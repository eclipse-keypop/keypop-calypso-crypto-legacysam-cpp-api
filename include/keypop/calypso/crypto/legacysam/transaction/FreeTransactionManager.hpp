 ...
 * @since 0.1.0
 */
class FreeTransactionManager : public ReadTransactionManager<FreeTransactionManager> {
public:
    /**
     ...
     * LegacyCardCertificateComputationData object.
     *
     ...
     * SAM. The central system SAM uses the master signing key, diversified before signing with the
     ...
     * @since 0.1.0
     */
    virtual FreeTransactionManager& prepareVerifySignature(SignatureVerificationData<?> data) = 0
     ...
     * @since 0.2.0
     */
    virtual const std::string exportTargetSamContextForAsyncTransaction() = 0;
};
