 ...
 * ::prepareComputeCardCertificate(LegacyCardCertificateComputationData)
 * method.
 *
 * @since 0.5.0
 */
...
public:
     ...
     *
     * <p>This key is expected to be on the <strong>secp256r1</strong> elliptic
     * curve. It will be used for the verification of card signatures.
     *
     ...
     */
    virtual LegacyCardCertificateComputationData&
    setStartDate(const tm& startDate)
        = 0;
     ...
     * @since 0.5.0
     */
    virtual LegacyCardCertificateComputationData& setEndDate(const tm& endDate)
        = 0;
     ...
     * @since 0.5.0
     */
    virtual const std::vector<uint8_t>& getCertificate() const = 0;
};
